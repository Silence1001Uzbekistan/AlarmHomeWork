...
import uz.artikov.alarmhomework.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showTimePicker() {
        ...
        picker.show(supportFragmentManager, "Artikov")
    ...
    private fun createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel = NotificationChannel("Artikov", name, importance)
